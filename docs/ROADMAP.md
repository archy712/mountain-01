...
| Phase 11 | 고비용·후순위                     | 047~050 | 🔄 진행 (048 완료 · 047·049·050 예정) | [Phase 8~11](roadmap/phase-8-11-expansion.md) |

- **Phase 10 완료:** Task 045(편의시설 화장실+대피소, 목록·상세·지도 마커/클러스터링, 519건)·Task 046(계절 명소·야생동물 주의) 완료. Task 044는 ⏸보류(개인 접근 실시간 소스 부재).
- **Phase 11 진행:** Task 048(사용자 후기·별점 — 방문완료한 산만 작성, 신고 누적 3회 자동 숨김 모더레이션, 별점 필수·텍스트 선택) 완료(2026-08-11). **다음 후보:** Task 047(푸시 알림, 백엔드 스케줄러 필요)·049(주차·교통, 소스 파편화로 재검토)·050(전망 사진, 최후순위) 또는 045 후속(식수대/매점). [Phase 8~11 문서](roadmap/phase-8-11-expansion.md) 참조.
