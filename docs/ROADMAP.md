...
- **진행 중:** Task 045(편의시설·**화장실+대피소** — 목록·상세 노출 **완료**, 총 519건, 지도 마커·식수대/매점은 후속)와 Task 046(계절 명소·야생동물, Step 1·2 완료·**Step 3(UI) 대기**)가 병렬 진행 중. Task 044는 ⏸보류(개인 접근 실시간 소스 부재). [Phase 8~11 문서](roadmap/phase-8-11-expansion.md) 참조.
